                                    ...
                                    <div id="typography">
                                        <div class="card-content">
                                            <form action="{{route('gprof')}}" method="POST">
                                                ...
                                                <div class="row">
                                                    <div class="col-md-3">
                                                        <h4 class="title">Primera Evaluación</h4>
                                                        <a href="{{URL::action('calif@evaluacion_uno')}}"><input type="button" class="btn btn-primary pull-left" data-background-color="red" value='Ingresar'></a>
                                                    </div>
                                                </div>
                                                <div class="row">
                                                    <div class="col-md-3">                                                
                                                        <h4 class="title">Segunda Evaluación</h4>
                                                        <a href="{{URL::action('calif@evaluacion_dos')}}"><input type="button" class="btn btn-primary pull-left" data-background-color="red" value='Ingresar'></a>
                                                    </div>
                                                </div>
                                            </form>
                                        </div>
