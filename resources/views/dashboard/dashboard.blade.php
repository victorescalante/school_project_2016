                        ...
                        <ul class="nav navbar-nav navbar-right">
                            ...
                            <li class="dropdown">
                                ...
                                <ul class="dropdown-menu">
                                    <li>
                                        <a href="{{URL::action('calif@modpassadm',['iddir'=>Session::get('sessioniddire')])}}">Modificar Contraseña</a>
                                    </li>
                                    <li>
                                        <a href="{{URL::action('login@cerrarsesiondir')}}">Cerrar Sesion</a>
                                    </li>
                                </ul>
                            </li>
                        </ul>
                ...
                <div class="container-fluid">
                    <nav class="pull-left">
                        <ul>
                            ...
                            <li>
                                <a href="{{URL::action('login@cerrarsesiondir')}}">
                                    Cerrar Sesion
                                </a>
                            </li>
                        </ul>
